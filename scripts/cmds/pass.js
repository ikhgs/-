...
async function getAnswerFromAI(question) {
    try {
        const services = [
            { url: 'https://hiroshi-rest-api.replit.app/ai/gemini', params: { prompt: question, uid: 'your-uid-here' } },
            { url: 'https://hiroshi-rest-api.replit.app/ai/gemini', params: { query: question } },
            { url: 'https://hiroshi-rest-api.replit.app/ai/gemini', params: { ask: question } }
        ];
